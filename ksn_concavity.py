...
name = 'himalaya_b_processed.csv'#,'himalaya_b_processed.csv','himalaya_c_processed.csv'
...
with open(target+name,'r') as csvfile:
  ...
  for row in csvReader:
    ...
    print current_path
    concavity_corrector = 'nohup nice python ./concavity_corrector.py %s %s %s&'%(current_path,fname,summary_directory)
